...
%ORIGINAL: url = ['https://sheets.googleapis.com/v4/spreadsheets/' spreadsheetID '?includeGridData=false'];
url = ['https://sheets.googleapis.com/v4/spreadsheets/' spreadsheetID '?&fields=sheets.properties'];  % This speeds it up hugely!  Based on comment on Matlab FX
MAXITER=10;
success=false;
safeguard=0;
